...
```bash
curl -L https://github.com/ominiverdi/ferrum/releases/download/v0.4.3/ferrum-v0.4.3-x86_64-unknown-linux-gnu.tar.gz | tar xz
sudo mv ferrum-v0.4.3-x86_64-unknown-linux-gnu/ferrum /usr/local/bin/
ferrum --help
```
...
```bash
curl -LO https://github.com/ominiverdi/ferrum/releases/download/v0.4.3/ferrum-v0.4.3-x86_64-unknown-linux-gnu.tar.gz
curl -LO https://github.com/ominiverdi/ferrum/releases/download/v0.4.3/ferrum-v0.4.3-x86_64-unknown-linux-gnu.tar.gz.sha256
sha256sum -c ferrum-v0.4.3-x86_64-unknown-linux-gnu.tar.gz.sha256
```
