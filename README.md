...
```bash
curl -LO https://github.com/ominiverdi/ferrum/releases/download/v0.4.10/ferrum-v0.4.10-x86_64-unknown-linux-gnu.tar.gz
curl -LO https://github.com/ominiverdi/ferrum/releases/download/v0.4.10/ferrum-v0.4.10-x86_64-unknown-linux-gnu.tar.gz.sha256
sha256sum -c ferrum-v0.4.10-x86_64-unknown-linux-gnu.tar.gz.sha256
```
